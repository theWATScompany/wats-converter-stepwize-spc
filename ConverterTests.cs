...
using WATS.Testing;
using Virinco.WATS.Converter.StepWize;

namespace Virinco.WATS.Converter.StepWize.Tests
{
    public class ConverterTests : ConverterTestBase
    {
        public ConverterTests(ITestOutputHelper output) : base(output) { }
        protected override IReportConverter_v2 CreateConverter() => new GenericXSPCConverter();
